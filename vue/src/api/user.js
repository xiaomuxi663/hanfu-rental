...
export function updateUserInfo(data) { return request({ url: '/user/update', method: 'put', data }) }
export function verifyUser(data) { return request({ url: '/user/verify', method: 'post', data }) }
